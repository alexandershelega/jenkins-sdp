...
env.DHUB_PROJECT = "analytics2"
env.DHUB_USER = "jenkins-test"
env.DHUB_PASS = "Dunerunner1"
env.SERVICE_NAME = "nginx-analytics"
...
node('slave-swarm-dind') {
    timestamps {
        ...
        checkout scm
        git url: 'https://github.com/alexandershelega/jenkins-sdp.git', branch: env.BRANCH_NAME, credentialsId: 'd3a36e01-c34a-41b6-96f9-fbea0131315e'
        }
